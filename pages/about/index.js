    ...
    info: [
      {
        ...
        icons: [<FaHtml5 />, <FaCss3 />, <FaJs />, <SiNextdotjs />, <SiPython />],
      },
      {
      ...
      },
      {
        ...
        icons: [<SiAdobexd />, <SiAdobephotoshop />, <SiAdobelightroom />, <TfiMicrosoft />, <SiAutodeskrevit />, <SiArchicad />, <SiSketchup />],
      },
    ],
  },
  {
      ...
      <div className="container mx-auto h-full flex flex-col items-center xl:flex-row gap-x-6">
        ...
        <div className="flex-1 flex flex-col justify-center">
          ...
          <motion.p variants={fadeIn("right", 0.4)} initial="hidden" animate="show" exit="hidden" className="max-w-[500px] mx-auto xl:mx-0 mb-6 xl:mb-12 px-2 xl:px-0">
            Hi, my name is{" "}
            <span className="text-accent font-extrabold">Muthuri Denis Mugambi</span>. I am a former architect turned software engineer. With a foundation in design and problem-solving from my years in architecture, I bring a unique perspective to building user-focused digital experiences.
          </motion.p>
          {/* counters */}
          <motion.div variants={fadeIn("right", 0.6)} initial="hidden" animate="show" exit="hidden" className="hidden md:flex md:max-w-xl xl:max-0 mb-8">
        ...
        <motion.div variants={fadeIn("left", 0.4)} initial="hidden" animate="show" exit="hidden" className="flex flex-col w-full xl:max-w-[48%] h-[480px]">
          <div className="flex gap-x-4 xl:gap-x-8 mx-auto xl:mx-0 mb-4">
            {aboutData.map((item, itemIndex) => {
              return (
                <div key={item.title} // Using item.title as a unique key
          ...
          <div className="py-2 xl:py-6 flex flex-col gap-y-2 xl:gap-y-4 items-center xl:items-start">
            {aboutData[index].info.map((infoItem, infoIndex) => {
              return (
                <div key={infoItem.title + infoIndex} // Ensuring uniqueness with title and index
                  ...
                  <div className="flex gap-x-4">
                    {infoItem.icons?.map((icon, iconIndex) => {
                      return (
                        <div key={iconIndex} // Key for icons
